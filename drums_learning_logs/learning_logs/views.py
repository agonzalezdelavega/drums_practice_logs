...
def view_sessions(request, start_date=default_start_date, end_date=default_end_date):
    ...
    return render(request, "learning_logs/view_sessions.html", context)
...
def view_sources(request):
    ...
    return render(request, "learning_logs/view_sources.html", context)
...
def new_source(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            new_source.save()
            return redirect("learning_logs:view_sources")
    else:
        form = SourceForm()
    context = {"form": form}
    return render(request, "learning_logs/new_source.html", context)
...
def edit_source(request, source_id):
    ...
    return render(request, "learning_logs/edit_source.html", context)
...
def new_print_exercise(request):
    ...
    context = {"form": form}
    return render(request, "learning_logs/new_print_exercise.html", context)
...
def new_online_exercise(request):
    ...
    context = {"form": form}
    return render(request, "learning_logs/new_online_exercise.html", context)
...
def edit_print_exercise(request, exercise_id):
    ...
    return render(request, "learning_logs/edit_print_exercise.html", context)
...
def edit_online_exercise(request, exercise_id):
    ...
    context = {"form": form, "exercise": exercise}
    return render(request, "learning_logs/edit_online_exercise.html", context)
